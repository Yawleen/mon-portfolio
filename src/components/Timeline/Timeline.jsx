        ...
        {eventsList.length > 1 ? (
              ...
              <Fragment key={event.id}>
                ...
                <div className={style.eventContainer}>
                  <div className={style.event}>
                    ...
                    {event.details && (
                      <p className={style.eventDetails}>{event.details}</p>
                    )}
                    {event.place && (
          ...
          <div className={style.eventContainer}>
            <div className={style.event}>
              ...
              {eventsList[0].details && (
                <p className={style.eventDetails}>{eventsList[0].details}</p>
              )}
              {eventsList[0].place && (
                <p className={style.eventPlace}>{eventsList[0].place}</p>
              )}
              {eventsList[0].link && (
                <a
                  className={style.eventLink}
                  href={eventsList[0].link}
                  target="_blank"
                >
                  Consulter
                </a>
